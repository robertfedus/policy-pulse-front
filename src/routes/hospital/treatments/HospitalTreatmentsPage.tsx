...
export default function TreatmentsPage() {
  ...
  // Optional: nice currency formatting while keeping UI intact
  const fmt = (n: number) =>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="flex items-center">
                      <FileText className="h-5 w-5 mr-2 text-primary" aria-hidden="true" />
                      {plan.title}
                    </CardTitle>
                    <CardDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-muted rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-bold">{fmt(plan.totalCost)}</p>
                  </div>
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-1">
                    ...
                    <p className="text-lg font-bold text-green-600">{fmt(plan.coveredAmount)}</p>
                  </div>
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-1">
                    ...
                    <p className="text-lg font-bold text-red-600">{fmt(plan.uncoveredAmount)}</p>
                  </div>
                </div>
                          ...
                          <div>
                            <p
                              className={`font-medium ${
                                treatment.removed ? "text-red-700 line-through" : "text-foreground"
                              }`}
                            >
                              {treatment.name}
                            </p>
